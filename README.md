...
Ensure you have Code Composer Studio installed. If not, download and install it from the [TI website](https://www.ti.com/tool/CCSTUDIO).

### Open the Project
1. Open Code Composer Studio.
2. Go to `File > Import` and select `Code Composer Studio > CCS Projects`.
3. Browse to the cloned repository directory and import the project.

### Build and Debug
1. Connect your TI LaunchPad to your computer.
2. Click on `Build` and then `Debug` in CCS.
3. The program should compile, and you can start debugging on the LaunchPad.
